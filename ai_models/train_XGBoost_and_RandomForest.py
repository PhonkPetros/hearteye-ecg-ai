...
metadata_df = pd.read_csv(
    "data/external/cleaned-dataset/labeled_and_cleaned_metadata.csv"
)
...
weights = compute_class_weight(
    class_weight="balanced", classes=classes, y=y_train_balanced
)
...
voting_clf = VotingClassifier(
    estimators=[("xgb", best_xgb), ("rf", rf_model)], voting="soft"
)
...
disp = ConfusionMatrixDisplay(
    confusion_matrix=conf_matrix, display_labels=label_encoder.classes_
)
